...
function mountScriptTools() {
  ...
  host.innerHTML='<details class="script-tools-box"><summary>Templates and script checks</summary><button class="btn btn-ghost" id="open-versions">Version history</button><div class="template-picker" id="prompt-template-picker"></div><p class="set-help" id="prompt-check-status" role="status"></p><button class="btn btn-ghost btn-sm" id="refresh-script-checks">Check saved script</button></details><details class="script-tools-box" id="assembled-details"><summary>What the AI sees</summary><p class="set-help">The assembled prompt from your saved settings. Save edits before refreshing.</p><button class="btn btn-ghost btn-sm" id="refresh-assembled">Refresh saved prompt</button><pre id="assembled-prompt" class="assembled-prompt" tabindex="0">Open this panel to load the saved prompt.</pre></details>';
  $('#open-versions').onclick=()=>go('versions');
