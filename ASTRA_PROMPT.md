...
2. Login screen for the magic-link flow, replacing the PIN gate. App shell reads `/api/me` for account name, plan badge, and Instagram status.
...
Week 2 is in WORK_SPLIT.md: Instagram connect UI, test-drive transcripts, billing and usage pages, team members, unread state in the inbox, mobile inbox, notifications, undo on send.
